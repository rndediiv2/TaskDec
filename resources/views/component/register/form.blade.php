                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_first_name]" wajib="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Last name</label>
                                            <input type="text" class="form-control input-lg" name="customs[cd_last_name]">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group form-group-default input-group col-md-12 col-sm-12 col-lg-12">
                                        <div class="form-input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_date_of_birth]" id="dateOfBirth" wajib="true">
                                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_occupation]" wajib="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default form-group-default-select2 required">
                                            ...
                                            {{ Form::select('customs[cd_nationality]', $country, '', ['class' => 'full-width input-lg', 'data-placeholder' => 'Select Country', 'data-init-plugin' => "select2", 'wajib' => 'true']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_passport_number]" wajib="true" maxlength="15">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_address_in]" wajib="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_voyage_number]" wajib="true" maxlength="15">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group form-group-default input-group col-md-12 col-sm-12 col-lg-12">
                                        <div class="form-input-group">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_arrival_date]" id="dateOfArrival" wajib="true">
                                        </div>
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" class="form-control input-lg" name="customs[cd_member]" wajib="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default required">
                                            <label>Number of accompanied baggage</label>
                                            <input type="text" class="form-control input-lg" name="customs[cd_number_baggage]" wajib="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default required">
                                            <label>Number of unaccompanied baggage (if any, and see the reverse side of this form)</label>
                                            <input type="text" class="form-control input-lg" name="customs[cd_unaccompanied_baggage]" wajib="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default required">
                                            <label>Email</label>
                                            <input type="text" class="form-control input-lg" name="customs[cd_email]" wajib="true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" checked="checked" class="chkBring" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_animals]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" checked="checked" class="chkBring" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_narcotics]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" checked="checked" class="chkBring" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_currency]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" checked="checked" class="chkBring" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_cigaretes]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" checked="checked" class="chkBring" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_merchandise]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group form-group-default input-group">
                                            ...
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                <input type="checkbox" class="chkBring" checked="checked" data-init-plugin="switchery" data-size="small" data-color="primary" name="customs[cd_bring_goods]" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row row-same-height">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="padding-30 sm-padding-5" id="goodsContainer">
                                ...
                                <div class="form-group-attached" id="tempGoodsItems"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="padding-20 sm-padding-5 sm-m-b-20 sm-m-t-20 bg-white clearfix">
                    <ul class="pager wizard no-style">
                        ...
                        <li class="next finish hidden">
                            <button class="btn btn-primary btn-cons btn-animated from-left fa fa-check-circle pull-right confirmSubmit" type="button" disabled="disabled">
                                <span>Submit</span>
                            </button>
                        </li>
                        ...
                        <li class="previous">
                            <button class="btn btn-default btn-cons fa fa-arrow-left pull-right" type="button">
                                <span>Previous</span>
                            </button>
                        </li>
                        <li>
...
<script>
    $(function() {
        $("#noticeGoodsContainer").css("display", "none");
    });
</script>
@endsection